...
function c84530781.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	e4:SetValue(c84530781.aclimit)
	Duel.RegisterEffect(e4,tp)
end
function c84530781.aclimit(e,re,tp)
	return not re:GetHandler():IsSetCard(0x8351) and re:IsActiveType(TYPE_SPELL+TYPE_TRAP+TYPE_MONSTER) and not re:GetHandler():IsImmuneToEffect(e)
end
