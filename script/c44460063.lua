...
function c44460063.cfilter(c)
	return (c:IsSetCard(0x679) or c:IsSetCard(0x680)) and c:IsAbleToGraveAsCost()
end
...
function c44460063.tfilter(c)
	return (c:IsSetCard(0x679) or c:IsSetCard(0x680)) and c:IsAbleToGrave()
end
...
function c44460063.damfilter(c)
	...
	and (c:IsSetCard(0x679) or c:IsSetCard(0x680))
end
