...
function c65050026.confil(c,tp)
	return c:IsType(TYPE_MONSTER) and c:IsType(TYPE_NORMAL) and c:IsPreviousLocation(LOCATION_ONFIELD) and c:GetPreviousControler()==tp and not c:IsType(TYPE_TOKEN)
end
