...
function c65050033.initial_effect(c)
	...
	e1:SetOperation(c65050033.atklimit)
	c:RegisterEffect(e1)
	--special summon rule
	...
	e4:SetCondition(c65050033.dircon)
	c:RegisterEffect(e4)
	 --Activate
...
function c65050033.atklimit(e,tp,eg,ep,ev,re,r,rp)
...
function c65050033.spcon(e,c)
	...
	return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsExistingMatchingCard(c65050033.cfilter,tp,LOCATION_ONFIELD,0,1,nil) 
end
function c65050033.cfilter1(c)
	return c:IsFaceup() and c:IsCode(15259703)
end
function c65050033.cfilter2(c)
	return c:IsFaceup() and c:IsType(TYPE_TOON)
end
function c65050033.dircon(e)
	local tp=e:GetHandlerPlayer()
	return Duel.IsExistingMatchingCard(c65050033.cfilter1,tp,LOCATION_ONFIELD,0,1,nil)
		and not Duel.IsExistingMatchingCard(c65050033.cfilter2,tp,0,LOCATION_MZONE,1,nil)
end
