...
function cm.tgfilter(c)
	return c:IsFaceup() and c:IsType(TYPE_XYZ) and c:IsSetCard(0xde5)
end
function cm.matfilter(c)
	return c:IsType(TYPE_MONSTER) and c:IsSetCard(0xde5)
end
...
function cm.drfilter(c,e)
	return c:IsSetCard(0xde5) and c:IsAbleToDeck() and c:IsCanBeEffectTarget(e)
end
