...
function c65050024.desop(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.IsExistingMatchingCard(c65050024.relfil,tp,LOCATION_HAND+LOCATION_MZONE,0,1,nil) and Duel.SelectYesNo(tp,aux.Stringid(65050024,0)) then
		local g=Duel.SelectMatchingCard(tp,c65050024.relfil,tp,LOCATION_HAND+LOCATION_MZONE,0,1,1,nil)
