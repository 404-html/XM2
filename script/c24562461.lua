...
function c24562461.e2opfil(c,e,tp)
	return c:IsSetCard(0x9390) and c:IsType(TYPE_MONSTER) and (c:IsAbleToHand() or c:IsCanBeSpecialSummoned(e,0,tp,false,false))
end
...
function c24562461.e2tgfil(c)
	return c:IsSetCard(0x9390) and c:IsType(TYPE_MONSTER) and c:IsAbleToHand() and c:IsFaceup()
end
